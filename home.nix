...
monitor = ${ if osConfig.networking.hostName == "jirachi"
	     then "eDP-1, 3840x2400@59.99400, 0x0, 2.6"
...
col.active_border = rgba(100,100,100,1) rgba(223,190,152,1) 90deg
...
bind = SUPER, Space, exec, waybar -c ~/.config/waybar/top.jsonc -s ~/.config/waybar/top.css & waybar -c ~/.config/waybar/bottom.jsonc -s ~/.config/waybar/bottom.css
